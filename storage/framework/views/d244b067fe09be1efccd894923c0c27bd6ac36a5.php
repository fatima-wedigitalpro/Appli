...
<center>
<form action="<?php echo e(route('compagne.create',['id'=>request()->id, 'language'=>app()->getLocale()] )); ?>" method="POST">
<?php echo csrf_field(); ?> 
<div class="card" style="width: 18rem;" >
  <div class="card-body">
    <h5 class="card-title"><?php echo e(__('Companion')); ?></h5>
  </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\myapp\resources\views/compagne/create.blade.php ENDPATH**/ ?>