...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row" style="display:none;">
                            <label  class="col-md-4 col-form-label text-md-right"><?php echo e(__('Campagne')); ?></label>

                            <div class="col-md-6" id="compagne" >
                            ...
                            <input type="checkbox" name="orgi" value="<?php echo e($compagne->id_Compagne); ?>"> <?php echo e($compagne->num_Compagne); ?> <br/><br/>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Documents\GitHub\Appli\resources\views/auth/register.blade.php ENDPATH**/ ?>