...
<center>
<form action="<?php echo e(route('sujet.Rdimension',['id'=>request()->id, 'language'=>app()->getLocale()] )); ?>" method="POST">
<?php echo csrf_field(); ?>
<div class="card" style="width: 18rem;" >
  ...
  <a href="<?php echo e(route('sujet.create',['id'=>request()->id, 'language'=>app()->getLocale()] )); ?>" class="card-link"><?php echo e(__('Add a subject')); ?></a
</div>
</center>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\myapp\resources\views/sujet/Rdimension.blade.php ENDPATH**/ ?>