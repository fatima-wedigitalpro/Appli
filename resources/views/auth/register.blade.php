                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register', app()->getLocale()) }}">
                        ...
                        <div class="form-group row" style="display:none;">
                            <label  class="col-md-4 col-form-label text-md-right">{{ __('Campagne') }}</label>

                            <div class="col-md-6" id="compagne" >
                            @foreach((\App\Compagne::where('id_Organisation',$organisation->id)->get()) as $compagne)
                            <input type="checkbox" name="orgi" value="{{$compagne->id_Compagne}}"> {{$compagne->num_Compagne}} <br/><br/>
                            @endforeach
                            </select>
                            </div>
                        </div>
